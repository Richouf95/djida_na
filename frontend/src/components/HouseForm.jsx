  ...
  return (
    <form onSubmit={handleSubmit}>
        <div className="mb-3">
            ...
            <input value={adresse} onChange={(e) => setAdresse(e.target.value)} type="text" className={`form-control ${emptyFields.includes('adresse') ? 'error' : ''}`} />
        </div>
        <div className="mb-3">
            <label className="form-label">Superficie</label>
            <input value={superficie} onChange={(e) => setSuperficie(e.target.value)} type="number" className={`form-control ${emptyFields.includes('superficie') ? 'error' : ''}`} />
        </div>
        <div className="mb-3">
            <label className="form-label">Nombre de chambre</label>
            <input value={nombreChambre} onChange={(e) => setNombreChambre(e.target.value)} type="number" className={`form-control ${emptyFields.includes('nombreChambre') ? 'error' : ''}`} />
        </div>
        <div className="mb-3">
            <label className="form-label">Nombre de salon</label>
            <input value={nombreSalon} onChange={(e) => setNombreSalon(e.target.value)} type="number" className={`form-control ${emptyFields.includes('nombreSalon') ? 'error' : ''}`} />
        </div>
        ...
        <div className="mb-3 form-check">
            ...
            }} type="checkbox" className={`form-check-input ${emptyFields.includes('coursUnique') ? 'error' : ''}`}/>
        ...
        <div className="mb-3 form-check">
            ...
            }} type="checkbox" className={`form-check-input ${emptyFields.includes('dependance') ? 'error' : ''}`}/>
        ...
        <div className="mb-3 form-check">
            ...
            }} type="checkbox" className={`form-check-input ${emptyFields.includes('jardin') ? 'error' : ''}`}/>
        ...
        <div className="mb-3 form-check">
            ...
            }} type="checkbox" className={`form-check-input ${emptyFields.includes('piscine') ? 'error' : ''}`}/>
            <label className="form-check-label">Piscine ?</label>
        </div>

        <div className="mb-3">
            <label className="form-label">Prix</label>
            <input value={prix} onChange={(e) => setPrix(e.target.value)} type="number" className={`form-control ${emptyFields.includes('prix') ? 'error' : ''}`} />
        </div>
        <div className="mb-3">
            <label className="form-label">Image Principale</label>
            <input onChange={handleImage} type="file" className={`form-control ${emptyFields.includes('imagePrincipale') ? 'error' : ''}`} />
        </div>
